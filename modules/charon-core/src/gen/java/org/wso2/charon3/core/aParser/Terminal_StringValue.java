...
public class Terminal_StringValue extends Rule {
    ...
    public static Terminal_StringValue parse(ParserContext context, String regex) {
        ...
        try {
            String value = context.text.substring(context.index, context.index + regex.length());
