...
public class ResourceManager<R extends AbstractSCIMObject> extends AbstractResourceManager {
    ...
    public ResourceManager() {
        this.genericType = (Class<R>) ( (ParameterizedType) getClass()
     ...
     */
    public SCIMResponse get(ResourceHandler<R> resourceHandler, String id, String attributes,
     ...
     */
    public SCIMResponse create(ResourceHandler<R> resourceHandler, String scimObjectString,
        ...
        try {
            ...
            ServerSideValidator.validateCreatedSCIMObject(resource, SCIMSchemaDefinitions.SCIM_GROUP_SCHEMA);
            ...
            if (createdResource != null) {
                ...
                SCIMConstants.GROUP_ENDPOINT) + "/" + createdResource.getId());
                httpHeaders.put(SCIMConstants.CONTENT_TYPE_HEADER, SCIMConstants.APPLICATION_JSON);
     ...
     */
    public SCIMResponse listWithGET(ResourceHandler<R> resourceHandler, String filter,
        ...
        try {
            ...
            return listResources(resourceHandler, startIndex, count, sortBy, sortOrder, domainName, attributes,
                                 excludeAttributes, rootNode);
     ...
     */
    private SCIMResponse listResources(ResourceHandler<R> resourceHandler, int startIndex, int count, String sortBy,
        ...
        try {
            ...
            List<Object> resources = resourceHandler.listResources(rootNode, startIndex, count,
    ...
    public SCIMResponse listWithPOST(ResourceHandler<R> resourceHandler, String resourceString) {
        try {
            ...
            return listResources(resourceHandler, searchRequest.getStartIndex(), searchRequest.getCount(),
                                 searchRequest.getSortBy(), searchRequest.getSortOder(),
                                 searchRequest.getDomainName(), searchRequest.getExcludedAttributesAsString(),
    ...
    public SCIMResponse updateWithPUT(ResourceHandler<R> resourceHandler, String existingId,
                                      String scimObjectString, String attributes, String excludeAttributes) {
        ...
        try {
            ...
            if (oldResource != null) {
                R validatedResource = (R) ServerSideValidator.validateUpdatedSCIMObject(oldResource,
                                                                                        resource,
                                                                                        schema);
            ...
            if (updatedResource != null) {
                ...
                Group copiedGroup = (Group) CopyUtil.deepCopy(updatedResource);
     ...
     * @param scimObjectString the request body
     */
    public SCIMResponse updateWithPATCH(ResourceHandler<R> resourceHandler, String existingId,
                                        String scimObjectString, String attributes, String excludeAttributes) {
        try {
            if (resourceHandler == null) {
                throw new InternalErrorException(NULL_RESOURCE_HANDLER);
            ...
            for (PatchOperation operation : opList) {
                ...
                if (operation.getOperation().equals(SCIMConstants.OperationalConstants.ADD)) {
                    ...
                    if (newResource == null) {
                        newResource = (R) PatchOperationUtil.doPatchReplace(operation, getDecoder(),
                                                                            oldResource, copyOfOldResource, schema);
                        copyOfOldResource = (R) CopyUtil.deepCopy(newResource);
            ...
            if (newResource != null) {
                ...
                //add location header
                httpHeaders.put(SCIMConstants.LOCATION_HEADER, getResourceEndpointURL(
                SCIMConstants.USER_ENDPOINT) + "/" + newResource.getId());
                httpHeaders.put(SCIMConstants.CONTENT_TYPE_HEADER, SCIMConstants.APPLICATION_JSON);
