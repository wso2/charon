...
public class SCIMConstants {
    ...
    public static class RoleSchemaConstants {
        ...
        public static final String AUDIENCE_TYPE_DESC =
                "A label indicating the resource type of the role's usable audience.";
        public static final String ROLE_PROPERTY_NAME_DESC = "Name of the role property.";
        public static final String ROLE_PROPERTY_VALUE_DESC = "Value of the role property.";
        public static final String ROLE_PROPERTIES_DESC = "A list of properties of the role.";
        ...
        public static final String ROLE_PROPERTY_VALUE_URI =
                "urn:ietf:params:scim:schemas:extension:2.0:Role:roleProperties.value";
