...
/**
 * OSGi service interface which uses to manage roleV3.
 */
public interface RoleV3Manager {
     ...
     */
    RoleV3 getRole(String id, Map<String, Boolean> requiredAttributes)
     ...
     * @throws BadRequestException     BadRequestException.
     */
    RolesV3GetResponse listRolesWithGET(Node node, Integer startIndex, Integer count, String sortBy, String sortOrder,
     ...
     * @throws NotFoundException       NotFoundException.
     */
    RoleV3 updateRole(RoleV3 oldRole, RoleV3 newRole)
     ...
     * @throws CharonException         CharonException.
     */
    RolesV3GetResponse listRolesWithPost(SearchRequest searchRequest, List<String> requiredAttributes)
     ...
     */
    RoleV3 patchRole(String roleId, Map<String, List<PatchOperation>> patchOperations)
            throws NotImplementedException, BadRequestException, CharonException, ConflictException, NotFoundException,
            ForbiddenException;
