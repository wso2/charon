...
/**
 * REST API exposed by Charon-Core to perform operations on RoleResourceV3.
 */
public class RoleResourceV3Manager extends AbstractResourceManager {

    private static final Logger LOG = LoggerFactory.getLogger(RoleResourceV3Manager.class);

    @Override
    public SCIMResponse getRole(String id, RoleV3Manager roleManager, String attributes, String excludeAttributes) {
        ...
        try {
            ...
            RoleV3 role = roleManager.getRole(id, requiredAttributes);
            if (role == null) {
            ...
            ServerSideValidator.validateRetrievedSCIMRoleV3Object(role, attributes, excludeAttributes);
    ...
    @Override
    public SCIMResponse createRole(String postRequest, RoleV3Manager roleManager) {
    ...
    @Override
    public SCIMResponse deleteRole(String id, RoleV3Manager roleManager) {
    ...
    @Override
    public SCIMResponse listWithGETRole(RoleV3Manager roleManager, String filter, Integer startIndexInt,
        ...
        try {
            ...
            RolesV3GetResponse rolesResponse = roleManager.listRolesWithGET(rootNode, startIndex, count, sortBy,
    ...
    @Override
    public SCIMResponse listWithPOSTRole(String searchRequest, RoleV3Manager roleManager) {
        ...
        try {
            ...
            RolesV3GetResponse rolesResponse = roleManager.listRolesWithPost(searchRequestObject, requestedAttributes);

            for (RoleV3 role : rolesResponse.getRoles()) {
    ...
    @Override
    public SCIMResponse updateWithPUTRole(String id, String putRequest, RoleV3Manager roleManager) {
        ...
        try {
            ...
            RoleV3 role = decoder.decodeResource(putRequest, schema, new RoleV3());
            RoleV3 updatedRole;

            // Retrieve the old object.
            RoleV3 oldRole = roleManager.getRole(id, requestAttributes);
            if (oldRole == null) {
                String error = "No role exists with the given id: " + id;
                throw new NotFoundException(error);
            }
            RoleV3 newRole = (RoleV3) ServerSideValidator.validateUpdatedSCIMObject(oldRole, role, schema);
    ...
    @Override
    public SCIMResponse updateWithPATCHRole(String id, String patchRequest, RoleV3Manager roleManager) {
        ...
        try {
            ...
            RoleV3 originalRole = (RoleV3) CopyUtil.deepCopy(oldRole);
            RoleV3 patchedRole = doPatchRole(oldRole, schema, patchRequest);
            RoleV3 updatedRole = roleManager.updateRole(originalRole, patchedRole);
            return getScimResponse(encoder, updatedRole);
    ...
    @Override
    public SCIMResponse updateUsersWithPUTRole(String id, String putRequest, RoleV3Manager roleManager) {
    ...
    @Override
    public SCIMResponse updateUsersWithPATCHRole(String id, String patchRequest, RoleV3Manager roleManager) {
        ...
        try {
            ...
            RoleV3 originalRole = (RoleV3) CopyUtil.deepCopy(oldRole);
            RoleV3 patchedRole = doPatchRole(oldRole, schema, patchRequest);
            RoleV3 updatedRole = roleManager.updateUsersRole(originalRole, patchedRole);
            return getScimResponse(encoder, updatedRole);
        } catch (NotFoundException | BadRequestException | NotImplementedException | CharonException | ConflictException
                 | InternalErrorException e) {
            return AbstractResourceManager.encodeSCIMException(e);
    ...
    @Override
    public SCIMResponse updateGroupsWithPUTRole(String id, String putRequest, RoleV3Manager roleManager) {
    ...
    @Override
    public SCIMResponse updateGroupsWithPATCHRole(String id, String patchRequest, RoleV3Manager roleManager) {
        ...
        try {
            ...
            RoleV3 originalRole = (RoleV3) CopyUtil.deepCopy(oldRole);
            RoleV3 patchedRole = doPatchRole(oldRole, schema, patchRequest);
            RoleV3 updatedRole = roleManager.updateGroupsRole(originalRole, patchedRole);
            return getScimResponse(encoder, updatedRole);
        } catch (NotFoundException | BadRequestException | NotImplementedException | CharonException | ConflictException
                 | InternalErrorException e) {
            return AbstractResourceManager.encodeSCIMException(e);
     ...
     * @throws BadRequestException BadRequestException.
     */
    private SCIMResponse processRoleList(RolesV3GetResponse rolesResponse, JSONEncoder encoder, int startIndex,
                                         String attributes, String excludeAttributes)
            throws CharonException, BadRequestException {

        if (rolesResponse == null) {
            rolesResponse = new RolesV3GetResponse(0, Collections.emptyList());
        }
        if (rolesResponse.getRoles() == null) {
            rolesResponse.setRoles(Collections.emptyList());
        }
        for (RoleV3 role : rolesResponse.getRoles()) {
            ServerSideValidator.validateRetrievedSCIMObject(role, SCIMSchemaDefinitions.SCIM_ROLE_V3_SCHEMA,
    ...
    protected ListedResource createListedResource(RolesV3GetResponse rolesResponse, int startIndex) {
    ...
    private SCIMResponse getScimResponse(JSONEncoder encoder, RoleV3 updatedRole)
        ...
        if (updatedRole != null) {
            ...
            RoleV3 copiedRole = (RoleV3) CopyUtil.deepCopy(updatedRole);
            encodedRole = encoder.encodeSCIMObject(copiedRole);
            // Add location header
            httpHeaders.put(SCIMConstants.LOCATION_HEADER,
                    getResourceEndpointURL(SCIMConstants.ROLE_V3_ENDPOINT) + "/" + updatedRole.getId());
            httpHeaders.put(SCIMConstants.CONTENT_TYPE_HEADER, SCIMConstants.APPLICATION_JSON);
        } else {
    ...
    private SCIMResponse updateWithPatchOperations(String existingRoleId, List<PatchOperation> opList,
                                                   RoleV3Manager roleManager, SCIMResourceTypeSchema schema,
                                                   JSONEncoder encoder) {
        ...
        try {
            ...
            RoleV3 updatedRole = roleManager.patchRole(existingRoleId, patchOperations);
            return getScimResponse(encoder, updatedRole);
    ...
    private SCIMResponse updateUsersWithPatchOperations(String existingRoleId, List<PatchOperation> opList,
        ...
        try {
            ...
            // Process the Role patch operation and update the patch operation object with required values.
            processRolePatchOperations(patchOperations, schema);
            RoleV3 updatedRole = roleManager.patchUsersRole(existingRoleId, patchOperations);
            return getScimResponse(encoder, updatedRole);
        } catch (NotFoundException | BadRequestException | NotImplementedException | ConflictException |
                 CharonException | InternalErrorException | ForbiddenException e) {
            return AbstractResourceManager.encodeSCIMException(e);
    ...
    private SCIMResponse updateGroupsWithPatchOperations(String existingRoleId, List<PatchOperation> opList,
        ...
        try {
            ...
            // Process the Role patch operation and update the patch operation object with required values.
            processRolePatchOperations(patchOperations, schema);
            RoleV3 updatedRole = roleManager.patchGroupsRole(existingRoleId, patchOperations);
            return getScimResponse(encoder, updatedRole);
        } catch (NotFoundException | BadRequestException | NotImplementedException | ConflictException |
                 CharonException | InternalErrorException | ForbiddenException e) {
            return AbstractResourceManager.encodeSCIMException(e);
    ...
    private RoleV3 doPatchRole(RoleV3 oldRole, SCIMResourceTypeSchema roleSchema, String patchRequest)
        ...
        RoleV3 originalRole = (RoleV3) CopyUtil.deepCopy(oldRole);
        RoleV3 copyOfOldRole = (RoleV3) CopyUtil.deepCopy(oldRole);

        RoleV3 patchedRole = null;
        List<PatchOperation> opList = getDecoder().decodeRequest(patchRequest);
        for (PatchOperation operation : opList) {
            switch (operation.getOperation()) {
                case SCIMConstants.OperationalConstants.ADD:
                    if (patchedRole == null) {
                        patchedRole = (RoleV3) PatchOperationUtil
                    ...
                    copyOfOldRole = (RoleV3) CopyUtil.deepCopy(patchedRole);
                    break;
                case SCIMConstants.OperationalConstants.REMOVE:
                    if (patchedRole == null) {
                        patchedRole = (RoleV3) PatchOperationUtil
        ...
        return (RoleV3) ServerSideValidator.validateUpdatedSCIMObject(originalRole, patchedRole, roleSchema);
    }
