...
/**
 * This is to perform SCIM service provider side validation according to SCIM spec.
 */
public class ClientSideValidator extends AbstractValidator {

    //validate scim object received from server side.
    ...
    //validate client created scim object.
}
